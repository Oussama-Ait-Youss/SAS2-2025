...
int main()
{
    ...
    do
    {
        ...
        while (1)
        {
            // user input if the user input is not a number or is out of range
        ...
        else if (user_input == 3)
        {
            ...
            for (int i = 0; i < number_of_books_added; i++)
            {
                //the function return if the user input name is equal to the book name
        ...
        else if (user_input == 5)
        {
            ...
            for (int i = 0; i < number_of_books_added; i++)
            {
                ...
                if (strcmp(Titre[i], update_input) == 0)
                {
                    //shift all the book to the left and decrease the numbre of book 
