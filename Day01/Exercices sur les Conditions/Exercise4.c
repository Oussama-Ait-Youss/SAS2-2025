...
int main(){
    ...
    int jour_rest,jour = 60,conge_accordes,conge_utilises;
    printf("Entrez le total de jours de conges accordes : ");
    scanf("%d",&conge_accordes);
    printf("Entrez le nombre de jours de conge utilises :");
    scanf("%d",&conge_utilises);
    prinf("Statu de l'employe (0 pour temps partie, 1 pour temps plein):");
    scanf()
